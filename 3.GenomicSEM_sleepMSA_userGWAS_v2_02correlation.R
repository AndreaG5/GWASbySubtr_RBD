...
for (i in 1:num_chunks) {
        ...
        path_name = paste0("~/genomicSEM/v2_sleepMSA/sem/chunks_GWAS02/chunk_GWAS_", i, ".RData", collapse = "")
        txt_name = paste0("~/genomicSEM/v2_sleepMSA/sem/txt02/chunk_GWAS_", i, ".txt", collapse = "")
